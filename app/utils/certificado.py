...
def generar_certificado(id_estudiante: int, path: str) -> BytesIO:
    ...
    parrafo5 = parrafo.add_run(f' estudiante de la {estudiante.facultad}, {estudiante.carrera}, ha cumplido con el trabajo de {estudiante.total_horas} HORAS de servicio académico en esta dependencia. Sus labores de servicio estuvieron deidcadas a:                                                          \n')
